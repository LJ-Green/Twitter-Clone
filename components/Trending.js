    ...
    <div className="hidden lg:flex flex-col ml-7 mt-4">
      ...
      <div className="w-[300px] h-[500px] bg-white bg-opacity-10 rounded-3xl mt-3">
        ...
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in UK</p>
          <h1 className="text-[15px] font-bold">Christiano Ronaldo</h1>
          <p className="text-xs text-gray-500">70K Tweets</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in UK</p>
          <h1 className="text-[15px] font-bold">PGA Tour</h1>
          <p className="text-xs text-gray-500">412K Tweets</p>
        </div>
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in UK</p>
        ...
        <div className="p-3 relative">
          <DotsHorizontalIcon className="w-5 text-gray-600 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in UK</p>
          <h1 className="text-[15px] font-bold">Premier League</h1>
